import { Nav, Container, Offcanvas, NavDropdown, Image } from "react-bootstrap";
      ...
      <Navbar bg="primary" variant={"dark"} expand={expand} className="mb-3 ">
        <Container fluid>
          ...
          <Navbar.Offcanvas
            ...
            placement="end"
          >
            <Offcanvas.Header closeButton className="bg_color">
              <Offcanvas.Title id={`offcanvasNavbarLabel-expand-${expand}`}>
                Menu
              </Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body className="bg_color">
              <Nav className="justify-content-end flex-grow-1 pe-3 ">
                ...
                <NavDropdown.ItemText>
                  <Image
                    thumbnail={true}
                    src="https://avatars.githubusercontent.com/u/64790767?v=4"
                  />
